...
contract BetMetadata is Initializable, PausableUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    /**
    * @dev Return the metadata of a Bet NFT for a tokenURI
    * @return string : the metadata of a token in JSON format base64 encoded
    */
    function getMetadata(string memory bet, string memory betOn, bool paidOut, uint256 betAmount) public view returns (string memory){
        ...
        '{"trait_type": "Wager Amount","value": "', KUtils.toString(betAmount), '"},'
